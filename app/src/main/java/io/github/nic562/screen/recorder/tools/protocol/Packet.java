package io.github.nic562.screen.recorder.tools.protocol;
...
public class Packet {
    ...
    private static Packet buildPacket(InetSocketAddress source, InetSocketAddress dest, int ipId) {
        ...
        ByteBuffer byteBuffer = ByteBuffer.allocate(DEF_BUFFER_SIZE);
        byteBuffer.flip();
    ...
    public static Packet buildUdpPacket(InetSocketAddress source, InetSocketAddress dest, int ipId) {
        Packet p = buildPacket(source, dest, ipId);
        p.isTCP = false;
        p.isUDP = true;
        p.ip4Header.protocol = Packet.IP4Header.TransportProtocol.UDP;
        p.ip4Header.protocolNum = 17;
    ...
    public static Packet buildTcpPacket(InetSocketAddress source, InetSocketAddress dest, byte flag, long ack, long seq, int ipId) {
        ...
        p.isTCP = true;
        p.isUDP = false;
        p.ip4Header.protocol = Packet.IP4Header.TransportProtocol.TCP;
        p.ip4Header.protocolNum = 6;
